// Mock data for Sitara scrapbook site
...
export const PILLARS = [
  {
    ...
    tapeColor: '#F7D774',
    rotate: -2.4,
    body: 'Opening doors for children who lack access, providing the tools and mentorship they need.',
  },
  {
    id: 'health',
    label: 'HEALTH',
    ...
    tapeColor: '#F4B6C2',
    rotate: 1.6,
    body: 'Raising awareness on vital issues, reminding the community that periods are natural.',
  },
  {
    id: 'fundraisers',
    label: 'FUNDRAISERS',
    ...
    tapeColor: '#C9B6E4',
    rotate: -1.2,
    body: 'Bringing people together through creative workshops like our Tote Bag Painting events.',
  },
];

export const SITARA_PROVIDES = [
  'Individual tote bags',
  'Paints & brushes',
  'Refreshments',
  'A1 vibe & aesthetics',
];
...
export const FUND_ALLOCATIONS = [
  {
    ...
    body: 'Distribute nourishing food packets to families in need.',
    color: '#F4B6C2',
  },
  {
    title: 'Pad Distribution',
    body: 'Conduct pad distribution drives across underserved communities.',
    color: '#C9B6E4',
  },
  {
    title: 'Future Workshops',
    body: 'Fund future creative workshops that spark joy and skill.',
    color: '#F7D774',
  },
];
...
export const TESTIMONIALS = [
  { name: 'Aditi, volunteer', quote: 'This isn\u2019t just a club. It feels like the most alive thing we do all week.' },
  { name: 'Kabir, donor', quote: 'You can feel the intent. Every rupee goes where they say it goes.' },
  { name: 'Meher, workshop kid', quote: 'I painted a sun. Miss said it was the brightest one.' },
];
...
export const DONATION = {
  upi: 'sitara.newdawn@upi',
  note: 'Every rupee funds a food packet, a pad, or a workshop seat.',
};

export const IG_HANDLE = '@sitara.newdawn';
